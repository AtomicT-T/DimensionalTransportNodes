package com.atomict_t.dimensionaltransportnodes.blocks.datablock;
...
public class DataBlock extends Block implements ITileEntityProvider {
    ...
    public DataBlock() {
        super(Material.ROCK);
        setUnlocalizedName(Config.modId + ".datablock");
        setRegistryName("datablock");
        GameRegistry.register(this);
        GameRegistry.register(new ItemBlock(this), getRegistryName());
        GameRegistry.registerTileEntity(DataTileEntity.class, Config.modId + "_datablock");
